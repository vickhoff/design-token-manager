...
function ToastViewport({ className, ...props }: ToastPrimitive.Viewport.Props) {
  return (
    <ToastPrimitive.Viewport
      ...
      className={cn(
        "pointer-events-none fixed inset-x-4 top-4 z-50 mx-auto w-auto max-w-sm outline-none sm:mx-auto sm:w-full",
        className,
      )}
      {...props}
    />
  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        ...
        "data-[type=success]:border-border-success data-[type=success]:bg-surface-success",
        className,
      )}
      {...props}
    />
